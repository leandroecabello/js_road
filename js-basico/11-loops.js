...
for/in - recorre las propiedades de un objeto (para objetos)

for/of - recorre los valores de un objeto iterable (para arrays)
...
while (estudiantes.length > 0) {
  ...
  // shift() es un método que saca un elemento del array de la posición 0 a la última
  // Pop() comienza de la última a la primera.
  saludarEstudiante(estudiante);
}
